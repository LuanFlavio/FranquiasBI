...
const GlobalStyles = (theme: Theme) => {
  ...
  return {
    ...
    '*::-webkit-scrollbar-track': {
      background: theme.palette.mode === 'light' ? '#E4E5EB !important' : '#1a1a1a !important',
    },
    '*::-webkit-scrollbar-thumb': {
      backgroundColor: theme.palette.mode === 'light' ? theme.palette.grey[400] + ' !important' : '#3d3d3d !important',
      borderRadius: '0.2rem',
    },
